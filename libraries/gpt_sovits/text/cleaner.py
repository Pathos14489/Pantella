...
#     from libraries.gpt_sovits.text import chinese
#     from libraries.gpt_sovits.text.symbols import symbols
# else:
#     from libraries.gpt_sovits.text import chinese2 as chinese
#     from libraries.gpt_sovits.text.symbols2 import symbols
...
def clean_text(text, language, version=None):
    ...
    language_module = __import__("libraries.gpt_sovits.text."+language_module_map[language],fromlist=[language_module_map[language]])
