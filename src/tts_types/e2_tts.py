...
settings_description = {
    ...
    "e2_tts_banned_voice_models": "A list of voice models to ban from being used by E2-TTS. This can be changed in your [game_id]_config.json. This is useful if you have a voice model that causes issues with E2-TTS, such as extremely long synthesis times or crashes.",
}
options = {}
settings = {}
loaded = False
